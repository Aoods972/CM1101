...
def normalise_input(user_input):
    ...
    formatted_text = (remove_spaces(remove_punct(user_input)))
...
def display_room(room):
    ...
    print("   ")                          #three pieces of whitespace used to create blank lines
    print(room["name"].upper())         #upper used to put the room name as all caps
    print("   ")
...
def menu(exits):
    ...
    while True:
        ...
        # Normalise the input
        player_input = normalise_input(players_input)
